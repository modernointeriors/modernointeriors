...
const translations = {
  en: {
    ...
    'contact.form.budget': 'Renovation Budget (VND)',
    'contact.form.projectType': 'Property Type',
    'contact.form.projectType.apartment': 'Apartment',
    'contact.form.projectType.house': 'House',
    'contact.form.projectType.villa': 'Villa',
    'contact.form.projectType.restaurant': 'Restaurant',
    'contact.form.projectType.cafe': 'Cafe',
    'contact.form.projectType.office': 'Office',
    'contact.form.projectType.hotel': 'Hotel',
    'contact.form.projectType.shop': 'Shop',
  ...
  vi: {
    ...
    'contact.form.budget': 'Ngân Sách Cải Tạo (VNĐ)',
    'contact.form.projectType': 'Loại Hình',
    'contact.form.projectType.apartment': 'Căn Hộ',
    'contact.form.projectType.house': 'Nhà Phố',
    'contact.form.projectType.villa': 'Biệt Thự',
    'contact.form.projectType.restaurant': 'Nhà Hàng',
    'contact.form.projectType.cafe': 'Quán Cà Phê',
    'contact.form.projectType.office': 'Văn Phòng',
    'contact.form.projectType.hotel': 'Khách Sạn',
    'contact.form.projectType.shop': 'Cửa Hàng',
    'contact.form.projectType.other': 'Khác',
    ...
    'admin.homepageTab': 'Trang Chủ',
    'admin.aboutTab': 'Giới Thiệu',
