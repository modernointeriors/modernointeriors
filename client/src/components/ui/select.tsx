...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-none border-0 border-b border-white/50 bg-transparent px-3 py-2 text-sm data-[placeholder]:text-white/30 focus:outline-none focus:border-b-2 focus:border-white/80 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
