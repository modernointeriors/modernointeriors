...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      {!isAdminPage && <footer className="bg-black text-white pt-10 pb-4 border-t border-gray-800 ml-12 md:ml-16">
        ...
        {/* Copyright bar — full width, outside the max-w container */}
        <div className="mt-5 pt-4 border-t border-white/10 flex items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
